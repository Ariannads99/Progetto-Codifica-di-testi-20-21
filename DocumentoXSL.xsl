            ...
            <!--Stampa pagina 18 (inizialmente non visibile)--> 
                        ...
                        <xsl:when test=".[@xml:id='pericope7']">
                            <xsl:for-each select="./tei:div">
                                <div class="note">
                                    ...
                                    <p class="ttl">Forma originaria delle abbreviazioni</p> 
                ...
                <div class="gloss">
                    <strong>Glosse (da <a href="https://raw.githubusercontent.com/angelodel80/corsoCodifica/master/CTaa20-21/progetto-esame/Ontology_F_d_S.owl" style="text-decoration:underline;">qui</a>)</strong><br/>
                        <xsl:for-each select="tei:TEI/tei:text/tei:back/tei:div/tei:ab/tei:gloss[@xml:lang='fr']">
                            - <i><xsl:value-of select="@xml:id"/></i>: <xsl:value-of select="./tei:ref"/><br/>
                    </xsl:for-each><br/>
                    <strong>Note (da <a href="https://github.com/angelodel80/corsoCodifica/blob/master/CTaa20-21/progetto-esame/Testi%20FdS_IT-Prolusioni%2BLettera%20a%20G.%20Paris%20(E.%20Fadda).pdf" style="text-decoration:underline;"><i><xsl:value-of select="tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:additional/tei:listBibl/tei:bibl[@xml:id='notes']/tei:title"/></i></a>)</strong><br/>
                        <xsl:for-each select="tei:TEI/tei:text/tei:back/tei:div/tei:ab/tei:gloss[@xml:lang='IT']">
                            - <i><xsl:value-of select="@xml:id"/></i>: <xsl:value-of select="./tei:ref"/><br/>
                    </xsl:for-each>
